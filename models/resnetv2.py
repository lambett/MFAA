...
class ResNet(nn.Module):
    ...
    def forward(self, x, is_feat=False, preact=False, mode='fc'):
        ...
        if is_feat:
            if preact:
                if mode == 'sdd':
                    return [f0, f1_pre, f2_pre, f3_pre, f4, f5], out, patch_score
                return [f0, f1_pre, f2_pre, f3_pre, f4, f5], out, covout
            else:
                if mode == 'sdd':
                    return [f0, f1, f2, f3, f4, f5], out, patch_score
                return [f0, f1, f2, f3, f4, f5], out, covout
        else:
            return x
